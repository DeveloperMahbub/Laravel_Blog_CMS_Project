...
<div class="container-fluid">
    <div class="block-header">
        <a class="btn btn-primary" href="{{ route('admin.post.create') }}"><i class="material-icons">add</i><span>Add New Post</span></a>
    </div>
    <!-- #END# Basic Examples -->
    <!-- Exportable Table -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($post->is_approved == false)
                                            <button type="button" class="btn btn-success waves-effect" title="Approve Post" onclick="approvePost({{ $post->id }})">
