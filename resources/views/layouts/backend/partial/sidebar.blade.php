<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        <div class="image">
            <img src="{{ Auth::user()->image ? url('/storage/profile/'.Auth::user()->image) : asset('assets/backend/images/user.png') }}" width="48" height="48" alt="User" />
        </div>
    ...
    <div class="legal">
        <div class="copyright">
            &copy; @php echo date("Y"); @endphp <a href="javascript:void(0);">Blog - Backend Design</a>.
        </div>
        {{-- <div class="version">
            <b>Version: </b> 1.0.5
        </div> --}}
