            ...
            <div class="col-lg-4 col-md-12 ">
                ...
                <div class="single-post info-area ">
                    ...
                    <div class="about-area">
                        ...
                        <p>{{ $author->name }}</p><br>
                        <p>{{ $author->about }}</p><br>
                        <strong class="badge badge-primary">Author Since : {{ $author->created_at->toDateString() }}</strong><br>
                        <strong class="badge badge-primary">Total Posts : {{ $author->posts->count() }}</strong>
